...
if gateway_mac is None:
    ...
    print("[*] Gateway {!s} is at {!s}".format(gateway_ip, gateway_mac))
...
if target_mac is None:
    ...
    print("[*] Target {!s} is at {!s}".format(target_ip, target_mac))
...
print("[*] Starting sniffer for {:d} packets".format(packet_count))
